...
function TopRatedCivilEngineers() {
  const [engineers, setEngineers] = useState([]);

  useEffect(() => {
    // Fetch data from the API
    fetch('http://127.0.0.1:8000/api/toprated-civil-engineer/')
  ...
  return (
    <div className='remove-padding'>
      <h2 className="px-8 mb-6">Top-Rated Civil Engineers</h2>
      <Carousel
...
export default TopRatedCivilEngineers;
...
//   return (
//     <>
//     <h2 className='px-5'>Top-Rated Civil Engineers</h2>
